...
class DocumentRetriever:
    ...
    def __init__(self, vectordb_path="vectordb_path", embedding_model_name="Alibaba-NLP/gte-large-en-v1.5"):
        """
        ...
        # self.vector_store = FAISS(persist_directory=self.vectordb_path, embedding_function=self.embedding)
        self.vector_store = FAISS.load_local(self.vectordb_path, self.embedding, allow_dangerous_deserialization = True)
